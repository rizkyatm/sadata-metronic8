            ...
            (e = document.querySelector("#kt_modal_create_account")) && new bootstrap.Modal(e), t = document.querySelector("#kt_create_account_stepper"), i = t.querySelector("#kt_create_account_form"), o = t.querySelector('[data-kt-stepper-action="submit"]'), s = t.querySelector('[data-kt-stepper-action="next"]'), (r = new KTStepper(t)).on("kt.stepper.changed", (function (e) {
                ...
                fields: {
                    ...
                    classifacition_name: {
                        validators: {
                            notEmpty: {
                                message: "Classifacition is required"
                            }
                        }
                    },
                ...
                fields: {
                    ...
                    origin: {
                        validators: {
                            notEmpty: {
                                message: "Origin select is required"
                            }
                        }
                    },
                    group: {
                        validators: {
                            notEmpty: {
                                message: "Group select is required"
                            }
                        }
                    },
                    size: {
                        validators: {
                            notEmpty: {
                                message: "Size select is required"
                            }
                        }
                    },
                    hierarchy:  {
                        validators: {
                            notEmpty: {
                                message: "Hierarchy select is required"
                            }
                        }
                    },
                ...
                fields: {
                    ...
                    packaging_content:  {
                        validators: {
                            notEmpty: {
                                message: "Packaging Content is required"
                            }
                        }
                    },
                    card_number: {
